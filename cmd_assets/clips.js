class YouTubeClip {
  constructor(videoTitle, videoUrl, seek, duration=null, volume=3){
...
exports.ericAndreClips = [
  ...
  new YouTubeClip("You're Watching Bird Up", "https://www.youtube.com/watch?v=DIQpYgrdh_0", 0, 6000, 3),
  ...
  new YouTubeClip("I Go Hard In The Paint", "https://www.youtube.com/watch?v=rSHvJJqrd2k", 45, 9000, 3),
  new YouTubeClip("You Didn't Get the Abortion?", "https://www.youtube.com/watch?v=Dlz8DVn1Mjc", 35, 3000),
  ...
  new YouTubeClip("My Real Voice", "https://www.youtube.com/watch?v=jANThtZJGrs", 89, 7000),
  new YouTubeClip("Have You Been Exposed to HIV", "https://www.youtube.com/watch?v=TtJI85veuPc", 156.5, 12000),
  new YouTubeClip("Yo You're Beautiful Man", "https://www.youtube.com/watch?v=IS-F50GI9Zo", 43, 3500),
  new YouTubeClip("Snort As Much As Possible", "https://www.youtube.com/watch?v=XFNVeFQ0cEk", 2, 8000),
  ...
  new YouTubeClip("311 Never Happened", "https://www.youtube.com/watch?v=3l7lLRjWfLE", 13, 7000, 3),
  new YouTubeClip("I Don't Trust Like That", "https://www.youtube.com/watch?v=zONW46d50A0", 39.5, 5000, 2),
  new YouTubeClip("Turn that Poop Into Wine", "https://www.youtube.com/watch?v=3j9XNhrwVtY", 2, 14000, 2),
  new YouTubeClip("These Handsome Athletic Black Men", "https://www.youtube.com/watch?v=6r0bjh5ifeY", 33, 11500, 4),
  new YouTubeClip("Human Centipede Freshman in the Quad", "https://www.youtube.com/watch?v=3l7lLRjWfLE", 32, 6000, 3),
  new YouTubeClip("Are You Familiar With Bukkake?", "https://www.youtube.com/watch?v=7rrcsJBQDoo", 49, 4500, 4),
  new YouTubeClip("Snail Down", "https://www.youtube.com/watch?v=4pRJsia5_A8", 84, 7000, 3)
];
