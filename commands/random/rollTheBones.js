...
module.exports = class RollTheBonesCmd extends Command {
  ...
  async run(message, args) {
    let roll = (this.findModes(this.generateHistogram(this.rawRoll())));
    let grade = this.gradedRoll(roll);
